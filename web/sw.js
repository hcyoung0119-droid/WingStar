const CACHE='wingstar-v5';
const SHELL=['/','/index.html','/manifest.json','/wingstar-bridge.js','/wingstar-media.js','/wingstar-profile.js','/music-credits.html','/flutter_bootstrap.js','/main.dart.js','/icons/Icon-192.png','/icons/Icon-512.png'];
